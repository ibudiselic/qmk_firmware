...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [IBUD_LAY_GAME] = LAYOUT_moonlander(
       ...
       KC_F7,               KC_F3,               KC_F2,               LCTL(KC_LALT),       KC_LALT,             KC_F8,                                                               TD(DANCE_3),         _,                   _,                   _,                   _,                   KC_RCTRL,
    ...
    [IBUD_LAY_SYM] = LAYOUT_moonlander(
       ...
       KC_DQUO,             KC_COLN,             KC_EQUAL,            KC_PLUS,             KC_LPRN,             KC_ASTR,             KC_ENTER,                  _,                   KC_SLASH,            KC_RPRN,             RSFT_T(KC_MINUS),    KC_UNDS,             KC_SCOLON,           KC_QUOTE,
