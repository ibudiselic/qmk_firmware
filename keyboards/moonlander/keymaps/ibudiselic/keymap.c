...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [IBUD_LAY_GAME] = LAYOUT_moonlander(
       ...
       KC_TAB,              KC_Q,                KC_W,                KC_E,                KC_R,                KC_T,                KC_HOME,                   KC_PGUP,             KC_Y,                KC_U,                KC_I,                KC_O,                KC_P,                KC_BACKSLASH,
       KC_ESCAPE,           KC_A,                KC_S,                KC_D,                KC_F,                KC_G,                KC_END,                    KC_ENTER,            KC_H,                KC_J,                KC_K,                KC_L,                KC_F12,              RGUI_T(KC_QUOTE),
       KC_LEFT_SHIFT,       KC_Z,                KC_X,                KC_C,                KC_V,                KC_B,                                                                KC_N,                KC_M,                KC_COMMA,            KC_DOT,              KC_SLASH,            KC_RIGHT_SHIFT,
       KC_F7,               KC_F3,               KC_F2,               LCTL(KC_LALT),       KC_LALT,             KC_F8,                                                               TD(DANCE_3),         _,                   _,                   _,                   _,                   KC_RIGHT_CTRL,
                                                                      KC_SPACE,            KC_F2,               KC_F1,                                                               KC_DELETE,           KC_BACKSPACE,        KC_F5
    ),
