...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [IBUD_LAY_GAME] = LAYOUT_moonlander(
       ...
       KC_F7,               KC_F3,               KC_F2,               LCTL(KC_LALT),       KC_LALT,             KC_TRANSPARENT,                                                      TD(DANCE_3),         KC_NO,               KC_TRANSPARENT,      KC_LBRACKET,         KC_RBRACKET,         KC_RCTRL,
    ...
    [IBUD_LAY_FKEYS] = LAYOUT_moonlander(
       ...
       KC_TRANSPARENT,      KC_TRANSPARENT,      KC_TRANSPARENT,      KC_TRANSPARENT,      KC_TRANSPARENT,      KC_TRANSPARENT,                                                      KC_TRANSPARENT,      KC_F10,              KC_TRANSPARENT,      KC_TRANSPARENT,      KC_TRANSPARENT,      KC_TRANSPARENT,
                                                                      KC_TRANSPARENT,      KC_TRANSPARENT,      KC_TRANSPARENT,                                                      KC_TRANSPARENT,      KC_TRANSPARENT,      KC_TRANSPARENT
    ),
    ...
    [IBUD_LAY_SYM] = LAYOUT_moonlander(
       ...
       KC_PERC,             KC_NO,               KC_NO,               KC_NO,               KC_NO,               KC_NO,                                                               KC_NO,               KC_NO,               KC_NO,               KC_NO,               KC_NO,               KC_TILD,
                                                                      KC_SPACE,            KC_DLR,              KC_HASH,                                                             KC_NO,               KC_NO,               KC_TRANSPARENT
    ),
};
// clang-format on
