...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [IBUD_LAY_BASE] = LAYOUT_moonlander(
       ...
       _,                   KC_F3,               KC_F2,               LSFT(KC_LALT),       KC_LALT,             TD(DANCE_0),                                                         TD(DANCE_2),         TD(DANCE_1),         KC_F1,               KC_LBRACKET,         KC_RBRACKET,         _,
    ...
    [IBUD_LAY_GAME] = LAYOUT_moonlander(
       ...
       KC_F7,               KC_F3,               KC_F2,               LCTL(KC_LALT),       KC_LALT,             KC_F8,                                                               TD(DANCE_3),         _,                   _,                   KC_LBRACKET,         KC_RBRACKET,         KC_RCTRL,
    ...
    [IBUD_LAY_CTRL] = LAYOUT_moonlander(
       _,                   _,                   _,                   _,                   _,                   _,                   _,                         KC_PSCREEN,          _,                   _,                   _,                   _,                   _,                   RESET,
